...
namespace br.ufc.mdcc.hpcshelf.gust.graph.impl.UndirectedGraphEWeightedImpl
{
	public class IUndirectedGraphEWeightedImpl : BaseIUndirectedGraphEWeightedImpl, IUndirectedGraph<CTN, V, E>
