...
{
	public abstract class BaseIJoinGustyCollectorImpl<M0,TF,IKey,IValue,OKey,OValue,BF,GIF>: Synchronizer, BaseIJoinGustyCollector<M0,TF,IKey,IValue,OKey,OValue,BF,GIF>
