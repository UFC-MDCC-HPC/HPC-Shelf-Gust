...
{
	//public abstract class BaseIJoinReadSourceImpl<M2,BF,IKey,IValue,GIF>: Synchronizer, BaseIJoinReadSource<M2,BF,IKey,IValue,GIF>
	public abstract class BaseIJoinReadSourceImpl<M2,GIF>: Synchronizer, BaseIJoinReadSource<M2,GIF>
