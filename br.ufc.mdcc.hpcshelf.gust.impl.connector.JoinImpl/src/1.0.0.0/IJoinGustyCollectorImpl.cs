...
{
	public class IJoinGustyCollectorImpl<M0,TF,IKey,IValue,OKey,OValue,BF,GIF> : BaseIJoinGustyCollectorImpl<M0,TF,IKey,IValue,OKey,OValue,BF,GIF>, IJoinGustyCollector<M0,TF,IKey,IValue,OKey,OValue,BF,GIF>
